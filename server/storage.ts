...
export interface IStorage {
  ...
  updateUser(user: User): Promise<User>; // Added updateUser method
...
async function createAdminIfNotExists() {
  const admin = await getUserByEmail('admin@gmail.com');
  if (!admin) {
    await createUser({
      name: 'Admin',
      email: 'admin@gmail.com',
      phone: '+8801700000000',
      password: 'cd7b9835bdfbd0a190d182c6552f5c29d8a3d16262f27b3e43bb2727b377604b.e91c41c03c9df821016d7066ee2c5ca9',
      verified: true,
      role: 'admin'
    });
